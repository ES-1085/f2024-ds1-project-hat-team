...
write.csv(data_2018_19, "../data/3_4_2018_19_final_data.csv")
```
...
write.csv(data_4_5_2018_19, "../data/4_5_2018_19_final_data.csv")
```
...
social_emotional_data <- data_2018_19 %>% 
...
ggplot(social_emotional_data, aes(x = season, y = percent_meeting_exceeding)) +
  geom_jitter(width = 0.2, size = 2, alpha = 0.7, color = "#66c2a5") +
  geom_smooth(aes(group = 1), method = "loess", se = TRUE, color = "black", fill = "darkgrey", linewidth = 1.2) +
  labs(title = "Group Observations of 3-4 Year Olds in Head Start Program", 
...
# Save the plot
ggsave("social_emotional_3_4_individuals_trend_2018_19.jpeg", path = "../data")
```
...
# Save the plot
ggsave("social_emotional_age_group_trend_2018_19.jpeg", path = "../data")
```

```{r line-and-box-plots}
# Filter for only the "Social-Emotional" category
social_emotional_data <- HS_2018_19_data %>%
  filter(category == "Social-Emotional")
...
ggsave("2018_19_3_4_vs_4_5_line_plot.jpeg", path = "../data")
...
ggsave("2018_19_boxplot_seasons.jpeg", path = "../data")
