...
ggplot(data_2018_19, aes(x = category, y = number_meeting_exceeding, fill = season)) +
  stat_summary(fun = "sum", geom = "bar") +
  labs(title = "Total Children Meeting/Exceeding Expectations by Category", 
       subtitle = "Arranged by Season", 
       x = "Category", 
       y = "Total Count") +
